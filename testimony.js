...
// Our three default testimonial images if none are provided:
...
function generateLandingPageHtml(parsedData) {
  ...
  // Testimonial images
  // If the user gave 1 or 2 images only, the rest fallback to default.
  // If none given, all 3 fallback to default.
